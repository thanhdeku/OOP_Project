...
public class Database
{
    ...
    public static void addLecturerList()
    {
        Scanner Input = new Scanner(System.in);
    ...
    public static void demoDatabase()
    {
        ...
        Course[] demoCourse = new Course[12];
        ...
        demoCourse[10] = new Project("PR1001","Project1",6,"Cluster Shortest Path Tree");
        demoCourse[11] = new Project("PR1002","Project1",6,"Wireless Sensor Network");
        for(int i=0; i<12; i++)
        ...
        demoClass[0] = new Class(111111, "IT3010", 1111,"D6-101","Monday");
        demoClass[1] = new Class(111112, "IT3020", 1112,"D6-102","Thursday");
        demoClass[2] = new Class(111113, "IT3030", 1113,"D6-103","Tuesday");
        demoClass[3] = new Class(111114, "IT3040", 1114,"D6-108","Wednesday");
        demoClass[4] = new Class(111115, "PH1120", 1115,"D6-109","Monday");
        demoClass[5] = new Class(111116, "PH1110", 1116,"D6-201","Friday");
        demoClass[6] = new Class(111117, "SSH1110", 1117,"D6-301","Wednesday");
        demoClass[7] = new Class(111118, "EM1010", 1118,"D6-501","Thursday");
        demoClass[8] = new Class(111119, "MI1120", 1119,"D6-107","Monday");
        demoClass[9] = new Class(111120, "PR1001", 1112,null,null);
        demoClass[10] = new Class(111121,"PR1002",1112,null,null);
        for(int i=0; i<11; i++)

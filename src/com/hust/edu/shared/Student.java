...
public class Student extends HustPerson
{
    ...
    public static void getStudentInfo(int id)
    {
        ...
        if(x != null)
        {
            ...
            System.out.println("        Lop          : " + x.studentClass);
...
//        System.out.println("8. Trang thai.");
    ...
    public void search(Scanner input){
        ...
        System.out.println("5. Tra cuu danh sach cac mon hoc dang hoc");
        System.out.println("6. Tra cuu danh sach lop sinh vien");
        ...
        switch (input.nextInt()){
            ...
            case 4:
                System.out.println("Hoc phi sinh vien la " + this.fee);
                break;
            case 5:
                List<Enroll> enrolList = Enroll.getEnrollbyStudentId(this.getId());
